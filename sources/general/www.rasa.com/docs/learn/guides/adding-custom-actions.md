# Source: https://www.rasa.com/docs/learn/guides/adding-custom-actions
...
## How it works[​](https://www.rasa.com/docs/learn/guides/adding-custom-actions/#how-it-works 'Direct link to How it works')
...
### Key components[​](https://www.rasa.com/docs/learn/guides/adding-custom-actions/#key-components 'Direct link to Key components')
...
### Input and output of actions[​](https://www.rasa.com/docs/learn/guides/adding-custom-actions/#input-and-output-of-actions 'Direct link to Input and output of actions')
...
#### Example[​](https://www.rasa.com/docs/learn/guides/adding-custom-actions/#example 'Direct link to Example')
...
![Action that checks restaurant availability in flow builder](https://www.rasa.com/docs/assets/images/restaurant_action-4063dc6a21fe8e69c31a8c2373f9883c.png)

### Storing response values[​](https://www.rasa.com/docs/learn/guides/adding-custom-actions/#storing-response-values 'Direct link to Storing response values')
...
## Trying out your Actions[​](https://www.rasa.com/docs/learn/guides/adding-custom-actions/#trying-out-your-actions 'Direct link to Trying out your Actions')
...
## Next Steps[​](https://www.rasa.com/docs/learn/guides/adding-custom-actions/#next-steps 'Direct link to Next Steps')
...
For more detailed information, check our [Custom Actions Reference](https://www.rasa.com/docs/reference/primitives/custom-actions/).

- [How it works](https://www.rasa.com/docs/learn/guides/adding-custom-actions/#how-it-works)
 - [Key components](https://www.rasa.com/docs/learn/guides/adding-custom-actions/#key-components)
 - [Input and output of actions](https://www.rasa.com/docs/learn/guides/adding-custom-actions/#input-and-output-of-actions)
 - [Storing response values](https://www.rasa.com/docs/learn/guides/adding-custom-actions/#storing-response-values)
- [Trying out your Actions](https://www.rasa.com/docs/learn/guides/adding-custom-actions/#trying-out-your-actions)
- [Next Steps](https://www.rasa.com/docs/learn/guides/adding-custom-actions/#next-steps)