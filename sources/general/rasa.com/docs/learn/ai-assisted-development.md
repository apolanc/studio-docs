...
## Step 7: Evaluate with simulation[​](https://rasa.com/docs/learn/ai-assisted-development/#step-7-evaluate-with-simulation 'Direct link to Step 7: Evaluate with simulation')
...
- [Rasa MCP Tools API Reference](https://rasa.com/docs/reference/api/rasa-mcp-tools/) — full list of all 19 tools with parameters and sample prompts
...
- [Step 7: Evaluate with simulation](https://rasa.com/docs/learn/ai-assisted-development/#step-7-evaluate-with-simulation)
