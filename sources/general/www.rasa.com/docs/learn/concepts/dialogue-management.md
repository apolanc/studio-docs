# Source: https://www.rasa.com/docs/learn/concepts/dialogue-management
...
## How dialogue management works[​](https://www.rasa.com/docs/learn/concepts/dialogue-management/#how-dialogue-management-works 'Direct link to How dialogue management works')

In the last section, we learned how Rasa's [dialogue understanding](https://www.rasa.com/docs/learn/concepts/dialogue-understanding/) component uses an LLM to generate a set of internal commands representing how the user wants to progress the conversation. Once commands are issued, they are passed on to the dialogue manager to guide the next steps:

![dialogue understanding](https://www.rasa.com/docs/assets/images/concepts_dialogue_management-46c8f43da139ee2802dc7b24fd60dd3c.png)
...
If you are curious how Rasa manages multiple active flows, dive into how the system activates and moves through [flows](https://www.rasa.com/docs/reference/config/policies/flow-policy/).

## Anatomy of a flow[​](https://www.rasa.com/docs/learn/concepts/dialogue-management/#anatomy-of-a-flow 'Direct link to Anatomy of a flow')
...
## Flow building in action[​](https://www.rasa.com/docs/learn/concepts/dialogue-management/#flow-building-in-action 'Direct link to Flow building in action')

Let’s build a simple flow to help users reset their password by collecting their email and sending a reset link.

### Steps to build the flow[​](https://www.rasa.com/docs/learn/concepts/dialogue-management/#steps-to-build-the-flow 'Direct link to Steps to build the flow')
...
### Visualization of the flow[​](https://www.rasa.com/docs/learn/concepts/dialogue-management/#visualization-of-the-flow 'Direct link to Visualization of the flow')
...
![Pro and no code flow](https://www.rasa.com/docs/assets/images/concepts_dm_password_reset_arrows-1f8fc464c0e33aeb3423be93bd0e36e4.png)
...
## Learn more[​](https://www.rasa.com/docs/learn/concepts/dialogue-management/#learn-more 'Direct link to Learn more')

- Learn how to build flows in [Rasa Studio](https://www.rasa.com/docs/studio/build/flow-building/introduction/)
- Learn how to build flows in [Rasa Pro](https://www.rasa.com/docs/pro/build/writing-flows/)
- How to use conditions to build [branching logic](https://www.rasa.com/docs/reference/primitives/conditions/)

- [How dialogue management works](https://www.rasa.com/docs/learn/concepts/dialogue-management/#how-dialogue-management-works)
- [Anatomy of a flow](https://www.rasa.com/docs/learn/concepts/dialogue-management/#anatomy-of-a-flow)
- [Flow building in action](https://www.rasa.com/docs/learn/concepts/dialogue-management/#flow-building-in-action)
 - [Steps to build the flow](https://www.rasa.com/docs/learn/concepts/dialogue-management/#steps-to-build-the-flow)
 - [Visualization of the flow](https://www.rasa.com/docs/learn/concepts/dialogue-management/#visualization-of-the-flow)
- [Learn more](https://www.rasa.com/docs/learn/concepts/dialogue-management/#learn-more)