# Source: https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-infra

warning

Before you begin, ensure you've completed the [Setup Steps](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-setup/) to set environment variables and clone a repo that this section requires.
