...
## Streaming custom actions[​](https://rasa.com/docs/reference/primitives/custom-actions/#streaming-custom-actions 'Direct link to Streaming custom actions')
...
### How to write a streaming action[​](https://rasa.com/docs/reference/primitives/custom-actions/#how-to-write-a-streaming-action 'Direct link to How to write a streaming action')
...
See the [SDK dispatcher reference](https://rasa.com/docs/reference/integrations/action-server/sdk-dispatcher/#streaming-responses) for the full API, including rich-content chunks, barge-in handling, and transport behaviour.

### Where streaming is supported[​](https://rasa.com/docs/reference/primitives/custom-actions/#where-streaming-is-supported 'Direct link to Where streaming is supported')

Real-time streaming requires a streaming-capable action executor **and** a streaming output channel. See [Built-in output channels with streaming support](https://rasa.com/docs/reference/channels/custom-connectors/#built-in-output-channels-with-streaming-support). Rasa Pro supports streaming custom actions on:
...
### HTTP action server fallback[​](https://rasa.com/docs/reference/primitives/custom-actions/#http-action-server-fallback 'Direct link to HTTP action server fallback')
...
### Voice barge-in during streaming[​](https://rasa.com/docs/reference/primitives/custom-actions/#voice-barge-in-during-streaming 'Direct link to Voice barge-in during streaming')
...
👉 [Interruptions during streaming custom actions](https://rasa.com/docs/reference/primitives/patterns/#interruptions-during-streaming-custom-actions)
...
- [Streaming custom actions](https://rasa.com/docs/reference/primitives/custom-actions/#streaming-custom-actions)
 - [How to write a streaming action](https://rasa.com/docs/reference/primitives/custom-actions/#how-to-write-a-streaming-action)
 - [Where streaming is supported](https://rasa.com/docs/reference/primitives/custom-actions/#where-streaming-is-supported)
 - [HTTP action server fallback](https://rasa.com/docs/reference/primitives/custom-actions/#http-action-server-fallback)
 - [Voice barge-in during streaming](https://rasa.com/docs/reference/primitives/custom-actions/#voice-barge-in-during-streaming)