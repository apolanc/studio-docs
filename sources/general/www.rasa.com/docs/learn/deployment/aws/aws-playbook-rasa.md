# Source: https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-rasa
...
## Kafka Installation[​](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-rasa/#kafka-installation 'Direct link to Kafka Installation')
...
## Assistant Setup[​](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-rasa/#assistant-setup 'Direct link to Assistant Setup')
...
### Values File[​](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-rasa/#values-file 'Direct link to Values File')
...
#### Pin the Rasa Pro Image to Match Your Local CLI[​](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-rasa/#pin-the-rasa-pro-image-to-match-your-local-cli 'Direct link to Pin the Rasa Pro Image to Match Your Local CLI')
...
#### Align `modelGroups` with Your Trained Bot[​](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-rasa/#align-modelgroups-with-your-trained-bot 'Direct link to align-modelgroups-with-your-trained-bot')
...
## Upload Your Trained Model[​](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-rasa/#upload-your-trained-model 'Direct link to Upload Your Trained Model')
...
## Deploy Rasa[​](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-rasa/#deploy-rasa 'Direct link to Deploy Rasa')
...
## Configure Ingress & TLS Certificate[​](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-rasa/#configure-ingress--tls-certificate 'Direct link to Configure Ingress & TLS Certificate')
...
A2A server with multiple replicas

If you enable `a2a_server` under Rasa endpoints Helm values and run more than one Rasa replica, configure sticky load balancing separately — the playbook ingress script does not include this by default. Apply an Istio EnvoyFilter and DestinationRule as described in [Multi-replica load balancing](https://www.rasa.com/docs/reference/integrations/a2a-server/#istio-on-kubernetes).

- [Kafka Installation](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-rasa/#kafka-installation)
- [Assistant Setup](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-rasa/#assistant-setup)
 - [Values File](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-rasa/#values-file)
- [Upload Your Trained Model](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-rasa/#upload-your-trained-model)
- [Deploy Rasa](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-rasa/#deploy-rasa)
- [Configure Ingress & TLS Certificate](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-rasa/#configure-ingress--tls-certificate)