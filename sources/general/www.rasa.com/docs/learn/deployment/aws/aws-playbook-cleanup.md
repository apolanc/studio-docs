# Source: https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-cleanup

warning

Following these steps will delete all of the infrastructure and configuration you have deployed in all the previous steps. You'll need to set the environment variables defined in [Setup Steps](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-setup/) before you begin.
