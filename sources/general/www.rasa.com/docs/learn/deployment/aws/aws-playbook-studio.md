# Source: https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-studio
...
## Studio Setup[​](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-studio/#studio-setup 'Direct link to Studio Setup')
...
### Values File[​](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-studio/#values-file 'Direct link to Values File')
...
## Deploy studio[​](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-studio/#deploy-studio 'Direct link to Deploy studio')
...
## Configure TLS Certificate[​](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-studio/#configure-tls-certificate 'Direct link to Configure TLS Certificate')
...
## Next Steps[​](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-studio/#next-steps 'Direct link to Next Steps')

- [Set up users and roles for Studio](https://www.rasa.com/docs/studio/installation/setup-guides/authorization-guide/).
- If you ever need to uninstall Rasa Platform and remove the deployed infrastructure, you can do so by following the instructions in the [Cleanup](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-cleanup/) section.

- [Studio Setup](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-studio/#studio-setup)
 - [Values File](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-studio/#values-file)
- [Deploy studio](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-studio/#deploy-studio)
- [Configure TLS Certificate](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-studio/#configure-tls-certificate)
- [Next Steps](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-studio/#next-steps)