# Source: https://www.rasa.com/docs/learn/guides/integrating-rag
...
## Types of AI Assistant Conversations[​](https://www.rasa.com/docs/learn/guides/integrating-rag/#types-of-ai-assistant-conversations 'Direct link to Types of AI Assistant Conversations')
...
## Understanding RAG[​](https://www.rasa.com/docs/learn/guides/integrating-rag/#understanding-rag 'Direct link to Understanding RAG')
...
## How RAG Works in Rasa[​](https://www.rasa.com/docs/learn/guides/integrating-rag/#how-rag-works-in-rasa 'Direct link to How RAG Works in Rasa')
...
## Getting Started with Enterprise Search[​](https://www.rasa.com/docs/learn/guides/integrating-rag/#getting-started-with-enterprise-search 'Direct link to Getting Started with Enterprise Search')

### Step One: Prep your Knowledge Base[​](https://www.rasa.com/docs/learn/guides/integrating-rag/#step-one-prep-your-knowledge-base 'Direct link to Step One: Prep your Knowledge Base')
...
#### Folder-Based Storage[​](https://www.rasa.com/docs/learn/guides/integrating-rag/#folder-based-storage 'Direct link to Folder-Based Storage')
...
#### Vector Database[​](https://www.rasa.com/docs/learn/guides/integrating-rag/#vector-database 'Direct link to Vector Database')
...
![Configure your Vector Store for Enterprise Search](https://www.rasa.com/docs/assets/images/config-es-vector-store-e19fd87c5478ac87683723e58f584202.png)

### Step Two: Configure the Command Generator and Enterprise Search[​](https://www.rasa.com/docs/learn/guides/integrating-rag/#step-two-configure-the-command-generator-and-enterprise-search 'Direct link to Step Two: Configure the Command Generator and Enterprise Search')
...
![Edit config.yml for enterprise search](https://www.rasa.com/docs/assets/images/config-es-policy-9fed06f9a353f51c7c4cfd4334372920.png) ![Edit endpoints.yml for enterprise search](https://www.rasa.com/docs/assets/images/endpoints-es-aec2f5a3656a6f79205a14f23965ca9a.png)

### Step Three: Override pattern\_search[​](https://www.rasa.com/docs/learn/guides/integrating-rag/#step-three-override-pattern_search 'Direct link to Step Three: Override pattern_search')
...
![Search for System Flows](https://www.rasa.com/docs/assets/images/system-flows-search-c120c2b466605900e7a7a4cec5a0c47d.png)
...
![Add Custom Action Step in System Flows](https://www.rasa.com/docs/assets/images/pattern-search-action-23f7b29c1a72ea847cf793118c11ef57.png)

This will send relevant queries to the default action `action_trigger_search`.

### Step Four: Try out your assistant[​](https://www.rasa.com/docs/learn/guides/integrating-rag/#step-four-try-out-your-assistant 'Direct link to Step Four: Try out your assistant')
...
![conversation example](https://www.rasa.com/docs/assets/images/rag_chat-ce15a70bfc6ccfb0f9be914390fe4478.gif)

Example conversation with a Rasa assistant using Enterprise Search

## Customization Options[​](https://www.rasa.com/docs/learn/guides/integrating-rag/#customization-options 'Direct link to Customization Options')

### LLM and Prompt Customization (Optional)[​](https://www.rasa.com/docs/learn/guides/integrating-rag/#llm-and-prompt-customization-optional 'Direct link to LLM and Prompt Customization (Optional)')
...
### Extractive Search (Optional)[​](https://www.rasa.com/docs/learn/guides/integrating-rag/#extractive-search-optional 'Direct link to Extractive Search (Optional)')
...
- [Types of AI Assistant Conversations](https://www.rasa.com/docs/learn/guides/integrating-rag/#types-of-ai-assistant-conversations)
- [Understanding RAG](https://www.rasa.com/docs/learn/guides/integrating-rag/#understanding-rag)
- [How RAG Works in Rasa](https://www.rasa.com/docs/learn/guides/integrating-rag/#how-rag-works-in-rasa)
- [Getting Started with Enterprise Search](https://www.rasa.com/docs/learn/guides/integrating-rag/#getting-started-with-enterprise-search)
 - [Step One: Prep your Knowledge Base](https://www.rasa.com/docs/learn/guides/integrating-rag/#step-one-prep-your-knowledge-base)
 - [Step Two: Configure the Command Generator and Enterprise Search](https://www.rasa.com/docs/learn/guides/integrating-rag/#step-two-configure-the-command-generator-and-enterprise-search)
 - [Step Three: Override pattern\_search](https://www.rasa.com/docs/learn/guides/integrating-rag/#step-three-override-pattern_search)
 - [Step Four: Try out your assistant](https://www.rasa.com/docs/learn/guides/integrating-rag/#step-four-try-out-your-assistant)
- [Customization Options](https://www.rasa.com/docs/learn/guides/integrating-rag/#customization-options)
 - [LLM and Prompt Customization (Optional)](https://www.rasa.com/docs/learn/guides/integrating-rag/#llm-and-prompt-customization-optional)
 - [Extractive Search (Optional)](https://www.rasa.com/docs/learn/guides/integrating-rag/#extractive-search-optional)