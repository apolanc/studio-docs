# Source: https://www.rasa.com/docs/learn/deployment/gcp/gcp-playbook-intro
...
#### Setup[​](https://www.rasa.com/docs/learn/deployment/gcp/gcp-playbook-intro/#setup 'Direct link to Setup')
...
#### Deploy Infrastructure[​](https://www.rasa.com/docs/learn/deployment/gcp/gcp-playbook-intro/#deploy-infrastructure 'Direct link to Deploy Infrastructure')
...
#### Configure Cluster[​](https://www.rasa.com/docs/learn/deployment/gcp/gcp-playbook-intro/#configure-cluster 'Direct link to Configure Cluster')
...
#### Install Rasa Pro[​](https://www.rasa.com/docs/learn/deployment/gcp/gcp-playbook-intro/#install-rasa-pro 'Direct link to Install Rasa Pro')

Configure and install Rasa Pro onto the cluster ready for production usage.

#### Install Rasa Studio[​](https://www.rasa.com/docs/learn/deployment/gcp/gcp-playbook-intro/#install-rasa-studio 'Direct link to Install Rasa Studio')

Configure and install Rasa Studio onto the cluster ready for production usage.

#### Cleanup[​](https://www.rasa.com/docs/learn/deployment/gcp/gcp-playbook-intro/#cleanup 'Direct link to Cleanup')
