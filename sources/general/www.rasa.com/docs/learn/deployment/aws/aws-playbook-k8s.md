# Source: https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-k8s
...
### Cluster Setup[​](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-k8s/#cluster-setup 'Direct link to Cluster Setup')
...
### Collect Required Parameters[​](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-k8s/#collect-required-parameters 'Direct link to Collect Required Parameters')
...
### Setup Database[​](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-k8s/#setup-database 'Direct link to Setup Database')
...
### Install external-dns[​](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-k8s/#install-external-dns 'Direct link to Install external-dns')
...
### Install cert-manager[​](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-k8s/#install-cert-manager 'Direct link to Install cert-manager')
...
### Test Ingress Setup[​](https://www.rasa.com/docs/learn/deployment/aws/aws-playbook-k8s/#test-ingress-setup 'Direct link to Test Ingress Setup')
