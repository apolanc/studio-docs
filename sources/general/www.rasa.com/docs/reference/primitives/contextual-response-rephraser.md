# Source: https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser
...
## Key Features[​](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#key-features 'Direct link to Key Features')
...
## Demo[​](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#demo 'Direct link to Demo')
...
## How to Use the Rephraser in Your Bot[​](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#how-to-use-the-rephraser-in-your-bot 'Direct link to How to Use the Rephraser in Your Bot')

The following assumes that you have already [configured your NLG server](https://www.rasa.com/docs/reference/integrations/nlg/).
...
## Various Ways to Use Rephrasing[​](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#various-ways-to-use-rephrasing 'Direct link to Various Ways to Use Rephrasing')

### Rephrasing a specific response[​](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#rephrasing-a-specific-response 'Direct link to Rephrasing a specific response')
...
### Rephrasing all responses[​](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#rephrasing-all-responses 'Direct link to Rephrasing all responses')
...
### Rephrasing all responses except for a few[​](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#rephrasing-all-responses-except-for-a-few 'Direct link to Rephrasing all responses except for a few')
...
### Disable rephrasing for default responses[​](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#disable-rephrasing-for-default-responses 'Direct link to Disable rephrasing for default responses')
...
This will disable rephrasing for the default response: [`utter_can_do_something_else`](https://www.rasa.com/docs/reference/primitives/patterns/#reference-default-pattern-configuration) and use the specified response instead.

## Customization[​](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#customization 'Direct link to Customization')

You can customize the LLM by modifying the following parameters in the `endpoints.yml` file.

### LLM configuration[​](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#llm-configuration 'Direct link to LLM configuration')
...
If you want to use Azure OpenAI Service, you can configure the necessary parameters as described in the [Azure OpenAI Service](https://www.rasa.com/docs/reference/config/components/llm-configuration/#azure-openai-service) section.
...
For more information, see the [LLM setup page on llms and embeddings](https://www.rasa.com/docs/reference/config/components/llm-configuration/)

### Temperature[​](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#temperature 'Direct link to Temperature')
...
#### Example using different temperatures[​](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#example-using-different-temperatures 'Direct link to Example using different temperatures')
...
### Prompt[​](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#prompt 'Direct link to Prompt')
...
- `history`: The [conversation history](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#conversation-history), e.g.
...
### Conversation History[​](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#conversation-history 'Direct link to Conversation History')
...
## Security Considerations[​](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#security-considerations 'Direct link to Security Considerations')
...
## Observations[​](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#observations 'Direct link to Observations')
...
### Success Cases[​](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#success-cases 'Direct link to Success Cases')
...
### Limitations[​](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#limitations 'Direct link to Limitations')
...
## Known Issues[​](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#known-issues 'Direct link to Known Issues')

- **Rephrasing of `utter_can_do_something_else`**:

 When a user's question is handled by the [`EnterpriseSearchPolicy`](https://www.rasa.com/docs/reference/config/policies/enterprise-search-policy/), the response rephraser may mistakenly overwrite the default `utter_can_do_something_else` response of the pattern [`pattern_completed`](https://www.rasa.com/docs/reference/primitives/patterns/) with a rephrased version of the answer provided by the `EnterpriseSearchPolicy`.

 _Workarounds_:

 1. Disable rephrasing for the `utter_can_do_something_else` response (see section [Disable rephrasing for default responses](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#disable-rephrasing-for-default-responses)).
 2. Set the `summarize_history` property of the rephraser to `False` (see section [Conversation History](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#conversation-history)).

- [Key Features](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#key-features)
- [Demo](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#demo)
- [How to Use the Rephraser in Your Bot](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#how-to-use-the-rephraser-in-your-bot)
- [Various Ways to Use Rephrasing](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#various-ways-to-use-rephrasing)
 - [Rephrasing a specific response](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#rephrasing-a-specific-response)
 - [Rephrasing all responses](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#rephrasing-all-responses)
 - [Rephrasing all responses except for a few](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#rephrasing-all-responses-except-for-a-few)
 - [Disable rephrasing for default responses](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#disable-rephrasing-for-default-responses)
- [Customization](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#customization)
 - [LLM configuration](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#llm-configuration)
 - [Temperature](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#temperature)
 - [Prompt](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#prompt)
 - [Conversation History](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#conversation-history)
- [Security Considerations](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#security-considerations)
- [Observations](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#observations)
 - [Success Cases](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#success-cases)
 - [Limitations](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#limitations)
- [Known Issues](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/#known-issues)