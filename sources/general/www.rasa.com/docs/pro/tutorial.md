# Source: https://www.rasa.com/docs/pro/tutorial

On this page

This quickstart takes you from a simple setup to a fully functional AI agent in just a few minutes.

## Requirements[​](https://www.rasa.com/docs/pro/tutorial/#requirements 'Direct link to Requirements')

Before getting started, make sure that you've already:

- [x] [**Created a License Key**](https://www.rasa.com/docs/pro/installation/licensing/)
- [x] [**Installed Rasa**](https://www.rasa.com/docs/pro/installation/python/)

## What are you building?[​](https://www.rasa.com/docs/pro/tutorial/#what-are-you-building 'Direct link to What are you building?')
...
## Following This Tutorial[​](https://www.rasa.com/docs/pro/tutorial/#following-this-tutorial 'Direct link to Following This Tutorial')

You'll need a free Rasa [Developer Edition license](https://www.rasa.com/docs/pro/installation/licensing/)
...
This assistant is powered by [an LLM that we fine-tuned and uploaded to huggingface](https://huggingface.co/rasa/command-generator-llama-3.1-8b-instruct). For convenience, this tutorial will use a deployment that we host and make available for users working through the tutorial. If you prefer, you don't have to use any 3rd party API and just [run this model yourself](https://www.rasa.com/docs/pro/deploy/deploy-fine-tuned-model/) or use [another LLM](https://www.rasa.com/docs/reference/config/components/llm-configuration/)

## Setup[​](https://www.rasa.com/docs/pro/tutorial/#setup 'Direct link to Setup')

Action Required

For new users, the easiest way to get started is the [Developer Quickstart](https://www.rasa.com/docs/learn/quickstart/pro/) — get a license, install Rasa Pro, and set up MCP in your IDE.

You can also [install Rasa Pro locally](https://www.rasa.com/docs/pro/installation/overview/) and use your own machine.
...
If you've completed the [Developer Quickstart](https://www.rasa.com/docs/learn/quickstart/pro/), you already have your license and MCP set up. If you've installed Rasa locally, set your Rasa license in an environment variable:
...
## Overview[​](https://www.rasa.com/docs/pro/tutorial/#overview 'Direct link to Overview')
...
## Testing your money transfer flow[​](https://www.rasa.com/docs/pro/tutorial/#testing-your-money-transfer-flow 'Direct link to Testing your money transfer flow')
...
## Understanding your money transfer flow.[​](https://www.rasa.com/docs/pro/tutorial/#understanding-your-money-transfer-flow 'Direct link to Understanding your money transfer flow.')
...
## Collecting Information in Slots[​](https://www.rasa.com/docs/pro/tutorial/#collecting-information-in-slots 'Direct link to Collecting Information in Slots')
...
After sending this message, Rasa will wait for a response from the user. When the user responds, Rasa will try to use their answer to fill the slot `recipient`. Read about [slot validation](https://www.rasa.com/docs/reference/primitives/flow-steps/#slot-validation) to learn how you can run extra checks on the slot values Rasa has extracted.
...
![explanation of how slots are used in flows](https://www.rasa.com/docs/assets/images/slots_in_flows-04d431fd342d165ce7083777126886f7.png)

### Descriptions in collect steps[​](https://www.rasa.com/docs/pro/tutorial/#descriptions-in-collect-steps 'Direct link to Descriptions in collect steps')
...
## Action Steps[​](https://www.rasa.com/docs/pro/tutorial/#action-steps 'Direct link to Action Steps')
...
## Branching Logic[​](https://www.rasa.com/docs/pro/tutorial/#branching-logic 'Direct link to Branching Logic')
...
Your custom action is defined in the file `actions/actions.py`. To learn more about custom actions, go [here](https://www.rasa.com/docs/reference/primitives/custom-actions/).
...
![diagram of how slots are used with custom actions](https://www.rasa.com/docs/assets/images/slot-communication-customaction-c9870e70736e597cb9f49ca28bfe4d9d.png)
...
## Testing your Custom Action[​](https://www.rasa.com/docs/pro/tutorial/#testing-your-custom-action 'Direct link to Testing your Custom Action')
...
## Adding Voice to Your Assistant[​](https://www.rasa.com/docs/pro/tutorial/#adding-voice-to-your-assistant 'Direct link to Adding Voice to Your Assistant')
...
### What You'll Need for Voice[​](https://www.rasa.com/docs/pro/tutorial/#what-youll-need-for-voice 'Direct link to What You'll Need for Voice')
...
Alternatively, you can use any of our other supported [Speech Integrations](https://www.rasa.com/docs/reference/integrations/speech-integrations/).

### Setting Up Your Voice Assistant[​](https://www.rasa.com/docs/pro/tutorial/#setting-up-your-voice-assistant 'Direct link to Setting Up Your Voice Assistant')
...
### Testing Your Voice Assistant[​](https://www.rasa.com/docs/pro/tutorial/#testing-your-voice-assistant 'Direct link to Testing Your Voice Assistant')
...
## Next Steps[​](https://www.rasa.com/docs/pro/tutorial/#next-steps 'Direct link to Next Steps')
...
2. Choose which LLM you want to use. This tutorial used an LLM that Rasa fine-tuned for this use case. For new projects created with `rasa init --template calm`, Rasa defaults to a general-purpose OpenAI chat model (`gpt-5.1-2025-11-13`) that doesn't require fine-tuning. You can configure which LLM to use by editing [the config.yml file in your project](https://www.rasa.com/docs/reference/config/components/llm-configuration/). When you're ready, you can [fine-tune your own model](https://www.rasa.com/docs/pro/customize/fine-tuning-llm/).

3. Start writing your own [flows](https://www.rasa.com/docs/reference/primitives/flows/) and [custom actions](https://www.rasa.com/docs/reference/primitives/custom-actions/).

- [Requirements](https://www.rasa.com/docs/pro/tutorial/#requirements)
- [What are you building?](https://www.rasa.com/docs/pro/tutorial/#what-are-you-building)
- [Following This Tutorial](https://www.rasa.com/docs/pro/tutorial/#following-this-tutorial)
- [Setup](https://www.rasa.com/docs/pro/tutorial/#setup)
- [Overview](https://www.rasa.com/docs/pro/tutorial/#overview)
- [Testing your money transfer flow](https://www.rasa.com/docs/pro/tutorial/#testing-your-money-transfer-flow)
- [Understanding your money transfer flow.](https://www.rasa.com/docs/pro/tutorial/#understanding-your-money-transfer-flow)
- [Collecting Information in Slots](https://www.rasa.com/docs/pro/tutorial/#collecting-information-in-slots)
 - [Descriptions in collect steps](https://www.rasa.com/docs/pro/tutorial/#descriptions-in-collect-steps)
- [Action Steps](https://www.rasa.com/docs/pro/tutorial/#action-steps)
- [Branching Logic](https://www.rasa.com/docs/pro/tutorial/#branching-logic)
- [Integrating an API call](https://www.rasa.com/docs/pro/tutorial/#integrating-an-api-call)
- [Testing your Custom Action](https://www.rasa.com/docs/pro/tutorial/#testing-your-custom-action)
- [Adding Voice to Your Assistant](https://www.rasa.com/docs/pro/tutorial/#adding-voice-to-your-assistant)
 - [What You'll Need for Voice](https://www.rasa.com/docs/pro/tutorial/#what-youll-need-for-voice)
 - [Setting Up Your Voice Assistant](https://www.rasa.com/docs/pro/tutorial/#setting-up-your-voice-assistant)
 - [Testing Your Voice Assistant](https://www.rasa.com/docs/pro/tutorial/#testing-your-voice-assistant)
- [Next Steps](https://www.rasa.com/docs/pro/tutorial/#next-steps)