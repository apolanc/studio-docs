# Source: https://www.rasa.com/docs/reference/telemetry
...
## Why do we use telemetry reporting?[​](https://www.rasa.com/docs/reference/telemetry/#why-do-we-use-telemetry-reporting 'Direct link to Why do we use telemetry reporting?')
...
## What about privacy and sensitive data?[​](https://www.rasa.com/docs/reference/telemetry/#what-about-privacy-and-sensitive-data 'Direct link to What about privacy and sensitive data?')
...
### No Data Sharing with Third Parties[​](https://www.rasa.com/docs/reference/telemetry/#no-data-sharing-with-third-parties 'Direct link to No Data Sharing with Third Parties')
...
### Data Collection[​](https://www.rasa.com/docs/reference/telemetry/#data-collection 'Direct link to Data Collection')
...
#### Inspecting Telemetry Data[​](https://www.rasa.com/docs/reference/telemetry/#inspecting-telemetry-data 'Direct link to Inspecting Telemetry Data')
...
## How to opt-out[​](https://www.rasa.com/docs/reference/telemetry/#how-to-opt-out 'Direct link to How to opt-out')
...
### Opt out with the Command Line[​](https://www.rasa.com/docs/reference/telemetry/#opt-out-with-the-command-line 'Direct link to Opt out with the Command Line')
...
### Opt out with environment variables[​](https://www.rasa.com/docs/reference/telemetry/#opt-out-with-environment-variables 'Direct link to Opt out with environment variables')
...
### Impact of opting out[​](https://www.rasa.com/docs/reference/telemetry/#impact-of-opting-out 'Direct link to Impact of opting out')
...
### Re-Enable Telemetry[​](https://www.rasa.com/docs/reference/telemetry/#re-enable-telemetry 'Direct link to Re-Enable Telemetry')
...
- [Why do we use telemetry reporting?](https://www.rasa.com/docs/reference/telemetry/#why-do-we-use-telemetry-reporting)
- [What about privacy and sensitive data?](https://www.rasa.com/docs/reference/telemetry/#what-about-privacy-and-sensitive-data)
 - [No Data Sharing with Third Parties](https://www.rasa.com/docs/reference/telemetry/#no-data-sharing-with-third-parties)
 - [Data Collection](https://www.rasa.com/docs/reference/telemetry/#data-collection)
- [How to opt-out](https://www.rasa.com/docs/reference/telemetry/#how-to-opt-out)
 - [Opt out with the Command Line](https://www.rasa.com/docs/reference/telemetry/#opt-out-with-the-command-line)
 - [Opt out with environment variables](https://www.rasa.com/docs/reference/telemetry/#opt-out-with-environment-variables)
 - [Impact of opting out](https://www.rasa.com/docs/reference/telemetry/#impact-of-opting-out)
 - [Re-Enable Telemetry](https://www.rasa.com/docs/reference/telemetry/#re-enable-telemetry)