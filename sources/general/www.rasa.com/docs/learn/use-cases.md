# Source: https://www.rasa.com/docs/learn/use-cases

On this page

### High-trust, fluent AI assistants[​](https://www.rasa.com/docs/learn/use-cases/#high-trust-fluent-ai-assistants 'Direct link to High-trust, fluent AI assistants')
...
### Real-time voice assistants that take action[​](https://www.rasa.com/docs/learn/use-cases/#real-time-voice-assistants-that-take-action 'Direct link to Real-time voice assistants that take action')
...
### Multilingual, personalized support assistants that handle hundreds of tasks[​](https://www.rasa.com/docs/learn/use-cases/#multilingual-personalized-support-assistants-that-handle-hundreds-of-tasks 'Direct link to Multilingual, personalized support assistants that handle hundreds of tasks')
...
### Custom, controllable conversational AI[​](https://www.rasa.com/docs/learn/use-cases/#custom-controllable-conversational-ai 'Direct link to Custom, controllable conversational AI')
...
### Ready to start?[​](https://www.rasa.com/docs/learn/use-cases/#ready-to-start 'Direct link to Ready to start?')

Check out the [Platform at a Glance](https://www.rasa.com/docs/learn/platform-introduction/)

- [High-trust, fluent AI assistants](https://www.rasa.com/docs/learn/use-cases/#high-trust-fluent-ai-assistants)
- [Real-time voice assistants that take action](https://www.rasa.com/docs/learn/use-cases/#real-time-voice-assistants-that-take-action)
- [Multilingual, personalized support assistants that handle hundreds of tasks](https://www.rasa.com/docs/learn/use-cases/#multilingual-personalized-support-assistants-that-handle-hundreds-of-tasks)
- [Custom, controllable conversational AI](https://www.rasa.com/docs/learn/use-cases/#custom-controllable-conversational-ai)
- [Ready to start?](https://www.rasa.com/docs/learn/use-cases/#ready-to-start)