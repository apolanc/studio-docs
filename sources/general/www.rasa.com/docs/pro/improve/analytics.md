# Source: https://www.rasa.com/docs/pro/improve/analytics
...
### Why No Out-of-the-Box Dashboards?[​](https://www.rasa.com/docs/pro/improve/analytics/#why-no-out-of-the-box-dashboards 'Direct link to Why No Out-of-the-Box Dashboards?')
...
## Installation Prerequisites[​](https://www.rasa.com/docs/pro/improve/analytics/#installation-prerequisites 'Direct link to Installation Prerequisites')
...
## What Can You Track with Analytics?[​](https://www.rasa.com/docs/pro/improve/analytics/#what-can-you-track-with-analytics 'Direct link to What Can You Track with Analytics?')
...
## Example Queries[​](https://www.rasa.com/docs/pro/improve/analytics/#example-queries 'Direct link to Example Queries')
...
### Number of Sessions per Month[​](https://www.rasa.com/docs/pro/improve/analytics/#number-of-sessions-per-month 'Direct link to Number of Sessions per Month')
...
![Number of sessions per month visualized in Metabase.](https://www.rasa.com/docs/assets/images/graph-number-sessions-month-b317f0dcc454cc14559b67bacad46e09.png)

Number of sessions per month visualized in Metabase.

### Number of Sessions per Channel[​](https://www.rasa.com/docs/pro/improve/analytics/#number-of-sessions-per-channel 'Direct link to Number of Sessions per Channel')
...
![Number of sessions per channel visualized in Metabase.](https://www.rasa.com/docs/assets/images/graph-number-sessions-channel-de63fa98d50b374c9d5647d3e3c19e6f.png)

The number of sessions per channel as visualized in Metabase.

### Abandonment Rate[​](https://www.rasa.com/docs/pro/improve/analytics/#abandonment-rate 'Direct link to Abandonment Rate')
...
![Abandonment rate visualized in Metabase.](https://www.rasa.com/docs/assets/images/graph-abandonment-rate-cc337b4ef1fa14408d69b14336c5722f.png)

Abandonment rate visualized in Metabase.

### Top N Flows in a Given Time Period[​](https://www.rasa.com/docs/pro/improve/analytics/#top-n-flows-in-a-given-time-period 'Direct link to Top N Flows in a Given Time Period')
...
### Escalation Rate[​](https://www.rasa.com/docs/pro/improve/analytics/#escalation-rate 'Direct link to Escalation Rate')
...
### Resolution Rate[​](https://www.rasa.com/docs/pro/improve/analytics/#resolution-rate 'Direct link to Resolution Rate')
...
### Drop-Off Rate for a specific Flow[​](https://www.rasa.com/docs/pro/improve/analytics/#drop-off-rate-for-a-specific-flow 'Direct link to Drop-Off Rate for a specific Flow')

The drop-off rate is a measure of the number of conversations that do not result in a completed flow. This metric is the inverse of the [resolution rate](https://www.rasa.com/docs/pro/improve/analytics/#resolution-rate) (e.g. 100% - resolution\_rate).
...
### Funnel Metrics[​](https://www.rasa.com/docs/pro/improve/analytics/#funnel-metrics 'Direct link to Funnel Metrics')
...
#### Count of Unique Sessions for Each Step in a Flow[​](https://www.rasa.com/docs/pro/improve/analytics/#count-of-unique-sessions-for-each-step-in-a-flow 'Direct link to Count of Unique Sessions for Each Step in a Flow')
...
#### Count of Unique Sessions for each Linked Flow[​](https://www.rasa.com/docs/pro/improve/analytics/#count-of-unique-sessions-for-each-linked-flow 'Direct link to Count of Unique Sessions for each Linked Flow')
