...
Counts may differ from Conversation Review

The volume shown here may not match what you see in Conversation Review for the same date range. Analytics counts sessions and is calculated in a nightly batch job, while Conversation Review counts conversations in real time.
...
## Escalation Insights[​](https://rasa.com/docs/studio/analyze/analytics/#escalation-insights 'Direct link to Escalation Insights')
...
![Escalation insights](https://rasa.com/docs/assets/images/escalation-insights-b2193c33500728c791c71725e0f5a377.png)
...
| --- | --- |
| Time period | Select the time window for your analytics data. Choose from **Last 7 days**, **Last 30 days**, or **Last 90 days**, or set a custom start and end date to focus on any specific period. |
...
- [Escalation Insights](https://rasa.com/docs/studio/analyze/analytics/#escalation-insights)
