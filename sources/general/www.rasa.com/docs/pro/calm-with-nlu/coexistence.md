# Source: https://www.rasa.com/docs/pro/calm-with-nlu/coexistence

On this page

## Key Terms[​](https://www.rasa.com/docs/pro/calm-with-nlu/coexistence/#key-terms 'Direct link to Key Terms')
...
- If no route is active:
 - We route to CALM if given the intent any of the NLU triggers of flows are activated (see [NLU triggers documentation](https://www.rasa.com/docs/reference/primitives/starting-flows/#nlu-trigger)).
...
The _Coexistence_ feature helps you to [migrate from your NLU-based](https://www.rasa.com/docs/pro/calm-with-nlu/migrating-from-nlu/) assistant to the [Conversational AI with Language Models (CALM)](https://www.rasa.com/docs/learn/concepts/calm/) approach and is available starting with version `3.8.0`. In order to start using the _Coexistence_ feature, follow the steps in the [user guide](https://www.rasa.com/docs/pro/calm-with-nlu/migrating-from-nlu/).

- [Key Terms](https://www.rasa.com/docs/pro/calm-with-nlu/coexistence/#key-terms)
- [Overview](https://www.rasa.com/docs/pro/calm-with-nlu/coexistence/#overview)
- [Intent triggers](https://www.rasa.com/docs/pro/calm-with-nlu/coexistence/#intent-triggers)