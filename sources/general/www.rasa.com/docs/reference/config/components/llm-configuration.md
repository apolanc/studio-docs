# Source: https://www.rasa.com/docs/reference/config/components/llm-configuration

On this page

LLM Configuration for Rasa Pro 3.10 and below

For Rasa Pro versions `3.10` and below, refer to the [LLM Configuration for `<=3.10`](https://www.rasa.com/docs/reference/config/components/llm-configuration/) page.

## Overview[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#overview 'Direct link to Overview')

This page applies to the following components which use LLMs:

- [SearchReadyLLMCommandGenerator](https://www.rasa.com/docs/reference/config/components/llm-command-generators/#searchreadyllmcommandgenerator)
- [CompactLLMCommandGenerator](https://www.rasa.com/docs/reference/config/components/llm-command-generators/#compactllmcommandgenerator)
- [EnterpriseSearchPolicy](https://www.rasa.com/docs/reference/config/policies/enterprise-search-policy/)
- [ContextualResponseRephraser](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/)
- [LLMBasedRouter](https://www.rasa.com/docs/reference/config/components/coexistence-routers/#llmbasedrouter)
- [SingleStepLLMCommandGenerator](https://www.rasa.com/docs/reference/config/components/deprecated-components/#singlestepllmcommandgenerator) (deprecated)
- [MultiStepLLMCommandGenerator](https://www.rasa.com/docs/reference/config/components/deprecated-components/#multistepllmcommandgenerator) (deprecated)
- [IntentlessPolicy](https://www.rasa.com/docs/reference/config/policies/intentless-policy/) (deprecated)
...
## Declaring LLM deployments[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#declaring-llm-deployments 'Direct link to Declaring LLM deployments')
...
### Model Groups[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#model-groups 'Direct link to Model Groups')
...
### Defining a single model group[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#defining-a-single-model-group 'Direct link to Defining a single model group')
...
#### Required Parameters[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#required-parameters 'Direct link to Required Parameters')
...
#### Optional Parameters[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#optional-parameters 'Direct link to Optional Parameters')
...
When configuring a particular provider, there are a few provider specific settings which are explained under each [provider's individual sub-section below](https://www.rasa.com/docs/reference/config/components/llm-configuration/).
...
#### Reasoning models and `reasoning_effort`[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#reasoning-models-and-reasoning_effort 'Direct link to reasoning-models-and-reasoning_effort')
...
#### Referencing environment variables in the model configuration[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#referencing-environment-variables-in-the-model-configuration 'Direct link to Referencing environment variables in the model configuration')
...
### Using a model group in a component[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#using-a-model-group-in-a-component 'Direct link to Using a model group in a component')
...
### Defining multiple model groups[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#defining-multiple-model-groups 'Direct link to Defining multiple model groups')
...
Multiple components can rely on the same model group and a single component can use multiple models defined in a model group, via the [LLM router](https://www.rasa.com/docs/reference/deployment/multi-llm-routing/).

## Chat completion models[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#chat-completion-models 'Direct link to Chat completion models')
...
### OpenAI[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#openai 'Direct link to OpenAI')

#### API Token[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#api-token 'Direct link to API Token')
...
#### Configuration[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#configuration 'Direct link to Configuration')
...
#### Model deprecations[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#model-deprecations 'Direct link to Model deprecations')
...
### Azure OpenAI Service[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#azure-openai-service 'Direct link to Azure OpenAI Service')

#### API Token[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#api-token-1 'Direct link to API Token')
...
#### Configuration[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#configuration-1 'Direct link to Configuration')
...
A more comprehensive example using the Azure OpenAI service in more CALM components is available [here](https://www.rasa.com/docs/reference/config/components/llm-configuration/#azure).

#### Model deprecations[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#model-deprecations-1 'Direct link to Model deprecations')
...
#### Debugging[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#debugging 'Direct link to Debugging')
...
### Amazon Bedrock[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#amazon-bedrock 'Direct link to Amazon Bedrock')

#### Requirements:[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#requirements 'Direct link to Requirements:')
...
#### Configuration[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#configuration-2 'Direct link to Configuration')
   ...
   model_groups:
     - id: amazon_bedrock
       models:
         - provider: bedrock
           model: anthropic.claude-instant-v1
           aws_access_key_id: ${MY_AWS_ACCESS_KEY_ID} # reference secret environment variable.
           aws_secret_access_key: ${MY_AWS_SECRET_ACCESS_KEY} # reference secret environment variable.
           aws_region_name: eu-central-1 # Does not require ${} as it is a not a secret.
           aws_session_token: ${MY_AWS_SESSION_TOKEN} # reference secret environment variable.
```
     ...
     - id: amazon_bedrock
       models:
         - provider: bedrock
           ...
           # No need to set aws_access_key_id, aws_secret_access_key, aws_region_name or aws_session_token
           # as they are automatically picked up from the IAM role attached to the Rasa Pro EC2 instance.
           # You should provide the inference profile ARN to the model_id parameter.
...
### Mistral[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#mistral 'Direct link to Mistral')

#### Requirements[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#requirements-1 'Direct link to Requirements')

1. Set the API key for Mistral platform to an environment variable `MISTRAL_API_KEY`.

#### Configuration[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#configuration-3 'Direct link to Configuration')
...
```yaml
    - name: CompactLLMCommandGenerator
      llm:
        model_group: mistral_models # Model group ID
```

### Gemini - Google AI Studio[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#gemini---google-ai-studio 'Direct link to Gemini - Google AI Studio')

#### Requirements:[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#requirements-2 'Direct link to Requirements:')
...
### HuggingFace Inference Endpoints[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#huggingface-inference-endpoints 'Direct link to HuggingFace Inference Endpoints')

#### Requirements:[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#requirements-3 'Direct link to Requirements:')
...
### Self Hosted Model Server[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#self-hosted-model-server 'Direct link to Self Hosted Model Server')
...
### Other Providers[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#other-providers 'Direct link to Other Providers')
...
## Embedding models[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#embedding-models 'Direct link to Embedding models')
...
### OpenAI[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#openai-1 'Direct link to OpenAI')

OpenAI is used as the default embedding model provider. To start using, ensure you have configured an API token as you would do for a [chat completion model from OpenAI platform](https://www.rasa.com/docs/reference/config/components/llm-configuration/#api-token)

#### Configuration[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#configuration-4 'Direct link to Configuration')
...
### Azure OpenAI Service[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#azure-openai-service-1 'Direct link to Azure OpenAI Service')

Ensure you have configured an API token as you would do for a [chat completion model for Azure OpenAI Service](https://www.rasa.com/docs/reference/config/components/llm-configuration/#api-token-1)

#### Configuration[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#configuration-5 'Direct link to Configuration')

Configuring an embedding model from Azure OpenAI Service needs values for the same set of parameters that are required for configuring a [chat completion model from Azure OpenAI Service](https://www.rasa.com/docs/reference/config/components/llm-configuration/#configuration-1)
...
### Amazon Bedrock[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#amazon-bedrock-1 'Direct link to Amazon Bedrock')

Configuring an embedding model from amazon bedrock needs the same pre-requisites as a [chat completion model](https://www.rasa.com/docs/reference/config/components/llm-configuration/#configuration-2). Please ensure you have addressed these before proceeding further.

#### Configuration[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#configuration-6 'Direct link to Configuration')
...
### Mistral[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#mistral-1 'Direct link to Mistral')

Configuring an embedding model from mistral needs the same pre-requisites as a [chat completion model](https://www.rasa.com/docs/reference/config/components/llm-configuration/#configuration-3). Please ensure you have addressed these before proceeding further.
...
```yaml
    - name: CompactLLMCommandGenerator
      llm:
        model_group: mistral_llm # Model group ID
      flow_retrieval:
        embeddings:
          model_group: mistral_embed
```

### In-Memory[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#in-memory 'Direct link to In-Memory')
...
#### Configuration[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#configuration-7 'Direct link to Configuration')
...
### Other Providers[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#other-providers-1 'Direct link to Other Providers')
...
## Configuring self-signed SSL certificates[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#configuring-self-signed-ssl-certificates 'Direct link to Configuring self-signed SSL certificates')
...
## Configuring Proxy URLs[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#configuring-proxy-urls 'Direct link to Configuring Proxy URLs')
...
## Recommended Models[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#recommended-models 'Direct link to Recommended Models')
...
| --- | --- | --- |
| `CompactLLMCommandGenerator`, `SearchReadyLLMCommandGenerator` | OpenAI, Azure, Anthropic, Bedrock | `gpt-5.1-2025-11-13` (default chat model; see [LLM Command Generators](https://www.rasa.com/docs/reference/config/components/llm-command-generators/#types-of-llm-based-command-generators) for prompt templates mapped to other models) |
...
## OAuth Authentication for Azure OpenAI[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#oauth-authentication-for-azure-openai 'Direct link to OAuth Authentication for Azure OpenAI')
...
### Setup[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#setup 'Direct link to Setup')
...
### Authentication Flow[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#authentication-flow 'Direct link to Authentication Flow')
...
### Authentication Options[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#authentication-options 'Direct link to Authentication Options')
...
### Client Secret Authentication[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#client-secret-authentication 'Direct link to Client Secret Authentication')
...
```yaml
model_groups:
  - id: devtribe_oauth_client_secret
    models:
      - provider: azure
        model: gpt-4
        deployment: test-gpt-4
        api_base: ${AZURE_API_GATEWAY_URL_FOR_AZURE_OPENAI_INSTANCE}
        ...
        oauth:
          ...
          authority_host: ${AZURE_AUTHORITY} # optional
```

### Client Certificate Authentication[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#client-certificate-authentication 'Direct link to Client Certificate Authentication')
...
```yaml
model_groups:
  - id: devtribe_oauth_client_certificate
    models:
      - provider: azure
        model: gpt-4
        deployment: test-gpt-4
        ...
        oauth:
          ...
          certificate_password: ${AZURE_CERTIFICATE_PASSWORD} # optional
          send_certificate_chain: False # optional
          authority_host: ${AZURE_AUTHORITY} # optional
          disable_instance_discovery: False # optional
```

### Default Azure Credentials Resolver[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#default-azure-credentials-resolver 'Direct link to Default Azure Credentials Resolver')
...
### OAuth with LiteLLM Router Configuration[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#oauth-with-litellm-router-configuration 'Direct link to OAuth with LiteLLM Router Configuration')

When using the LiteLLM router, you can configure OAuth authentication for multiple models. Here's an example configuration:

```yaml
model_groups:
  - id: devtribe_oauth_mixed
    models:
      - provider: azure
        deployment: test-gpt-4
        api_base: ${AZURE_API_GATEWAY_URL_1}
        api_version: 2024-03-01-preview
        oauth:
          type: azure_entra_id_client_secret
          scopes: ${AZURE_APP_SCOPE_1}
          client_id: ${AZURE_CLIENT_ID_1}
          tenant_id: ${AZURE_TENANT_ID_1}
          client_secret: ${AZURE_CLIENT_SECRET_1}
      - provider: azure
        deployment: test-gpt-4o
        api_base: ${AZURE_API_GATEWAY_URL_2}
        api_version: 2024-03-01-preview
        oauth:
          type: azure_entra_id_default
          scopes: ${AZURE_SCOPE_2}
    router:
...
### Custom OAuth Component[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#custom-oauth-component 'Direct link to Custom OAuth Component')
...
class AzureEntraIDClientCreds(OAuth):
    ...
    @classmethod
    def from_config(cls, config: Dict[str, Any]) -> CustomOAuth:
        # Method from_config is
        # called with the config: Dict[str, Any]
        # (what is under the oauth section in endpoints.yml)
        # and returns an instance of the class which implements the OAuth interface.
    ...
    def get_bearer_token(self) -> str:
        # Method get_bearer_token returns a bearer token which
        # will be used in a call to the Azure OpenAI
        # instance which is protected by the Gateway (Azure API Management service).

        # Implementation
        client = create_azure_entra_id_client_credentials(
        ...
        return client.get_token(*self.scopes).token

# We cache the client credential creation using the `lru_cache`
# decorator to avoid creating a new client for each request.
# This makes sure that refresh token is used to obtain the access
# token when the token expires and that client credentials/certificate are not
# used to obtain the token for each request.
@lru_cache
  ...
  - id: devtribe_oauth_client_secret
    models:
      - provider: azure
        ...
        api_version: 2024-03-01-preview
        oauth:
          # path to the custom OAuth component relative to the working directory
          type: addons.oauth.azure_entra_id_client_creds.AzureEntraIDClientCreds
          scopes: ${AZURE_SCOPE_CUSTOM}
          client_id: ${AZURE_CLIENT_ID_CUSTOM}
          tenant_id: ${AZURE_TENANT_ID_CUSTOM}
          client_secret: ${AZURE_CLIENT_SECRET}
```

## FAQ[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#faq 'Direct link to FAQ')

### Does OpenAI use my data to train their models?[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#does-openai-use-my-data-to-train-their-models 'Direct link to Does OpenAI use my data to train their models?')
...
## Example Configurations[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#example-configurations 'Direct link to Example Configurations')

### Azure[​](https://www.rasa.com/docs/reference/config/components/llm-configuration/#azure 'Direct link to Azure')
...
- [Overview](https://www.rasa.com/docs/reference/config/components/llm-configuration/#overview)
- [Declaring LLM deployments](https://www.rasa.com/docs/reference/config/components/llm-configuration/#declaring-llm-deployments)
 - [Model Groups](https://www.rasa.com/docs/reference/config/components/llm-configuration/#model-groups)
 - [Defining a single model group](https://www.rasa.com/docs/reference/config/components/llm-configuration/#defining-a-single-model-group)
 - [Using a model group in a component](https://www.rasa.com/docs/reference/config/components/llm-configuration/#using-a-model-group-in-a-component)
 - [Defining multiple model groups](https://www.rasa.com/docs/reference/config/components/llm-configuration/#defining-multiple-model-groups)
 - [Using different model groups in different components](https://www.rasa.com/docs/reference/config/components/llm-configuration/#using-different-model-groups-in-different-components)
- [Chat completion models](https://www.rasa.com/docs/reference/config/components/llm-configuration/#chat-completion-models)
 - [OpenAI](https://www.rasa.com/docs/reference/config/components/llm-configuration/#openai)
 - [Azure OpenAI Service](https://www.rasa.com/docs/reference/config/components/llm-configuration/#azure-openai-service)
 - [Amazon Bedrock](https://www.rasa.com/docs/reference/config/components/llm-configuration/#amazon-bedrock)
 - [Mistral](https://www.rasa.com/docs/reference/config/components/llm-configuration/#mistral)
 - [Gemini - Google AI Studio](https://www.rasa.com/docs/reference/config/components/llm-configuration/#gemini---google-ai-studio)
 - [HuggingFace Inference Endpoints](https://www.rasa.com/docs/reference/config/components/llm-configuration/#huggingface-inference-endpoints)
 - [Self Hosted Model Server](https://www.rasa.com/docs/reference/config/components/llm-configuration/#self-hosted-model-server)
 - [Other Providers](https://www.rasa.com/docs/reference/config/components/llm-configuration/#other-providers)
- [Embedding models](https://www.rasa.com/docs/reference/config/components/llm-configuration/#embedding-models)
 - [OpenAI](https://www.rasa.com/docs/reference/config/components/llm-configuration/#openai-1)
 - [Azure OpenAI Service](https://www.rasa.com/docs/reference/config/components/llm-configuration/#azure-openai-service-1)
 - [Amazon Bedrock](https://www.rasa.com/docs/reference/config/components/llm-configuration/#amazon-bedrock-1)
 - [Mistral](https://www.rasa.com/docs/reference/config/components/llm-configuration/#mistral-1)
 - [In-Memory](https://www.rasa.com/docs/reference/config/components/llm-configuration/#in-memory)
 - [Other Providers](https://www.rasa.com/docs/reference/config/components/llm-configuration/#other-providers-1)
- [Configuring self-signed SSL certificates](https://www.rasa.com/docs/reference/config/components/llm-configuration/#configuring-self-signed-ssl-certificates)
- [Configuring Proxy URLs](https://www.rasa.com/docs/reference/config/components/llm-configuration/#configuring-proxy-urls)
- [Recommended Models](https://www.rasa.com/docs/reference/config/components/llm-configuration/#recommended-models)
- [OAuth Authentication for Azure OpenAI](https://www.rasa.com/docs/reference/config/components/llm-configuration/#oauth-authentication-for-azure-openai)
 - [Setup](https://www.rasa.com/docs/reference/config/components/llm-configuration/#setup)
 - [Authentication Flow](https://www.rasa.com/docs/reference/config/components/llm-configuration/#authentication-flow)
 - [Authentication Options](https://www.rasa.com/docs/reference/config/components/llm-configuration/#authentication-options)
 - [Client Secret Authentication](https://www.rasa.com/docs/reference/config/components/llm-configuration/#client-secret-authentication)
 - [Client Certificate Authentication](https://www.rasa.com/docs/reference/config/components/llm-configuration/#client-certificate-authentication)
 - [Default Azure Credentials Resolver](https://www.rasa.com/docs/reference/config/components/llm-configuration/#default-azure-credentials-resolver)
 - [OAuth with LiteLLM Router Configuration](https://www.rasa.com/docs/reference/config/components/llm-configuration/#oauth-with-litellm-router-configuration)
 - [Custom OAuth Component](https://www.rasa.com/docs/reference/config/components/llm-configuration/#custom-oauth-component)
- [FAQ](https://www.rasa.com/docs/reference/config/components/llm-configuration/#faq)
 - [Does OpenAI use my data to train their models?](https://www.rasa.com/docs/reference/config/components/llm-configuration/#does-openai-use-my-data-to-train-their-models)
- [Example Configurations](https://www.rasa.com/docs/reference/config/components/llm-configuration/#example-configurations)
 - [Azure](https://www.rasa.com/docs/reference/config/components/llm-configuration/#azure)