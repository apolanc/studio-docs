# Source: https://www.rasa.com/docs/learn/concepts/calm
...
## Key Benefits[​](https://www.rasa.com/docs/learn/concepts/calm/#key-benefits 'Direct link to Key Benefits')
...
## Who is CALM For?[​](https://www.rasa.com/docs/learn/concepts/calm/#who-is-calm-for 'Direct link to Who is CALM For?')
...
## How CALM Works[​](https://www.rasa.com/docs/learn/concepts/calm/#how-calm-works 'Direct link to How CALM Works')
...
![Rasa CALM Dialogue System](https://www.rasa.com/docs/assets/images/calm_dialogue_system-b0775e6678a77872ab61fa3dd2a55265.png)

### 1\. Dialogue Understanding[​](https://www.rasa.com/docs/learn/concepts/calm/#1-dialogue-understanding 'Direct link to 1. Dialogue Understanding')

With every incoming user message, CALM performs [dialogue understanding](https://www.rasa.com/docs/learn/concepts/dialogue-understanding/):
...
### 2\. Dialogue Management[​](https://www.rasa.com/docs/learn/concepts/calm/#2-dialogue-management 'Direct link to 2. Dialogue Management')

Once commands are issued, the [dialogue manager](https://www.rasa.com/docs/learn/concepts/dialogue-management/) decides how to execute them. Commands could instruct the dialogue manager to:

- Start, stop, or resume a flow
- Leverage a [conversation pattern](https://www.rasa.com/docs/learn/concepts/conversation-patterns/) flow to handle unexpected interactions automatically
...
### 3\. Contextual Response Rephraser[​](https://www.rasa.com/docs/learn/concepts/calm/#3-contextual-response-rephraser 'Direct link to 3. Contextual Response Rephraser')

By default, your assistant sends templated messages to the user, however:

- You can optionally use the [contextual response rephraser](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/) to improve fluency and coherence
- You can customize the rephraser's prompt and use it only for specific messages

## CALM compared to ReAct-Style Agents & Classic Chatbots[​](https://www.rasa.com/docs/learn/concepts/calm/#calm-compared-to-react-style-agents--classic-chatbots 'Direct link to CALM compared to ReAct-Style Agents & Classic Chatbots')
...
## Smaller Models, Big Results[​](https://www.rasa.com/docs/learn/concepts/calm/#smaller-models-big-results 'Direct link to Smaller Models, Big Results')
...
## Learn more about CALM[​](https://www.rasa.com/docs/learn/concepts/calm/#learn-more-about-calm 'Direct link to Learn more about CALM')
...
- [Key Benefits](https://www.rasa.com/docs/learn/concepts/calm/#key-benefits)
- [Who is CALM For?](https://www.rasa.com/docs/learn/concepts/calm/#who-is-calm-for)
- [How CALM Works](https://www.rasa.com/docs/learn/concepts/calm/#how-calm-works)
 - [1\. Dialogue Understanding](https://www.rasa.com/docs/learn/concepts/calm/#1-dialogue-understanding)
 - [2\. Dialogue Management](https://www.rasa.com/docs/learn/concepts/calm/#2-dialogue-management)
 - [3\. Contextual Response Rephraser](https://www.rasa.com/docs/learn/concepts/calm/#3-contextual-response-rephraser)
- [CALM compared to ReAct-Style Agents & Classic Chatbots](https://www.rasa.com/docs/learn/concepts/calm/#calm-compared-to-react-style-agents--classic-chatbots)
- [Smaller Models, Big Results](https://www.rasa.com/docs/learn/concepts/calm/#smaller-models-big-results)
- [Learn more about CALM](https://www.rasa.com/docs/learn/concepts/calm/#learn-more-about-calm)