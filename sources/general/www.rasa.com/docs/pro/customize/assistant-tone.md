# Source: https://www.rasa.com/docs/pro/customize/assistant-tone
...
## Ways of Customizing Assistant Tone in Rasa[​](https://www.rasa.com/docs/pro/customize/assistant-tone/#ways-of-customizing-assistant-tone-in-rasa 'Direct link to Ways of Customizing Assistant Tone in Rasa')
...
## What Is the Response Rephraser?[​](https://www.rasa.com/docs/pro/customize/assistant-tone/#what-is-the-response-rephraser 'Direct link to What Is the Response Rephraser?')
...
See the [Response Rephraser reference page](https://www.rasa.com/docs/reference/primitives/contextual-response-rephraser/) for more detail on parameters like the LLM model, temperature, or how to provide a custom prompt template.

## What Are Conditional Response Variations?[​](https://www.rasa.com/docs/pro/customize/assistant-tone/#what-are-conditional-response-variations 'Direct link to What Are Conditional Response Variations?')
...
See the [Conditional Response Variations reference](https://www.rasa.com/docs/reference/primitives/responses/#conditional-response-variations) for detailed YAML examples and capabilities.

## When to Use Which?[​](https://www.rasa.com/docs/pro/customize/assistant-tone/#when-to-use-which 'Direct link to When to Use Which?')
...
## How to Create Conditional Response Variations[​](https://www.rasa.com/docs/pro/customize/assistant-tone/#how-to-create-conditional-response-variations 'Direct link to How to Create Conditional Response Variations')
...
## How to Customize the Response Rephraser[​](https://www.rasa.com/docs/pro/customize/assistant-tone/#how-to-customize-the-response-rephraser 'Direct link to How to Customize the Response Rephraser')
...
### 1\. Enabling Rephraser Across All Responses[​](https://www.rasa.com/docs/pro/customize/assistant-tone/#1-enabling-rephraser-across-all-responses 'Direct link to 1. Enabling Rephraser Across All Responses')
...
### 2\. Enabling Rephraser for Specific Responses[​](https://www.rasa.com/docs/pro/customize/assistant-tone/#2-enabling-rephraser-for-specific-responses 'Direct link to 2. Enabling Rephraser for Specific Responses')
...
### 3\. Setting a Custom Prompt[​](https://www.rasa.com/docs/pro/customize/assistant-tone/#3-setting-a-custom-prompt 'Direct link to 3. Setting a Custom Prompt')
...
## How to Test Rephrased Responses?[​](https://www.rasa.com/docs/pro/customize/assistant-tone/#how-to-test-rephrased-responses 'Direct link to How to Test Rephrased Responses?')
...
1. [**Generative Response Is Relevant**](https://www.rasa.com/docs/reference/testing/e2e/assertions/#generative-response-is-relevant-assertion)
...
2. [**Generative Response Is Grounded**](https://www.rasa.com/docs/reference/testing/e2e/assertions/#generative-response-is-grounded-assertion)
