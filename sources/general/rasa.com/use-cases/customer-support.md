# Source: https://rasa.com/use-cases/customer-support

![](https://cdn.prod.website-files.com/68e69c204ba0666edacc94b1/68f26329c220594ba8ed83c0_customer%20support%20pattern.svg)

# Customer support that scales without sacrificing quality

## Customer support that scales

## without sacrificing quality

Give your team the tools they need to resolve routine issues quickly with automation, and make room for deeper support work
...
Resolve FAQs and repetitive issues automatically so agents can focus on critical needs.

Technical support & troubleshooting

Guide users step by step through device or software issues with smart decision trees.

Billing & payments

Automate billing questions, send reminders, and accept payments 24/7.

Subscription & account changes

Handle account updates and plan changes without a support rep.

Order tracking & post-purchase support

Answer “where’s my order” before it hits your ticket queue.

Appointment rescheduling

Let patients reschedule or cancel without calling the front desk.

Claims status updates

Let customers check claim progress without needing to call in.

First notice of loss (FNOL)

Kick off the claims process with automated, structured reporting.
