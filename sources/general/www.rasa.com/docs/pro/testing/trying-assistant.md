# Source: https://www.rasa.com/docs/pro/testing/trying-assistant
...
## Interface Description[​](https://www.rasa.com/docs/pro/testing/trying-assistant/#interface-description 'Direct link to Interface Description')
...
### Preview[​](https://www.rasa.com/docs/pro/testing/trying-assistant/#preview 'Direct link to Preview')
...
### Flow[​](https://www.rasa.com/docs/pro/testing/trying-assistant/#flow 'Direct link to Flow')
...
### History[​](https://www.rasa.com/docs/pro/testing/trying-assistant/#history 'Direct link to History')
...
The test conversation carried out in the chat widget is represented here in the [end-to-end test format](https://www.rasa.com/docs/reference/testing/e2e/test-cases/). This helps to quickly transform the conversation into a test case which when added to your end-to-end test set can enhance the robustness of the assistant.

### Memory[​](https://www.rasa.com/docs/pro/testing/trying-assistant/#memory 'Direct link to Memory')
...
## Inspecting Voice Assistants[​](https://www.rasa.com/docs/pro/testing/trying-assistant/#inspecting-voice-assistants 'Direct link to Inspecting Voice Assistants')
...
Checkout the [speech integrations](https://www.rasa.com/docs/reference/integrations/speech-integrations/) page for the full list of supported ASR and TTS providers and their environment variables.

## Inspecting Conversations over External Channels[​](https://www.rasa.com/docs/pro/testing/trying-assistant/#inspecting-conversations-over-external-channels 'Direct link to Inspecting Conversations over External Channels')
...
- [Interface Description](https://www.rasa.com/docs/pro/testing/trying-assistant/#interface-description)
 - [Preview](https://www.rasa.com/docs/pro/testing/trying-assistant/#preview)
 - [Flow](https://www.rasa.com/docs/pro/testing/trying-assistant/#flow)
 - [History](https://www.rasa.com/docs/pro/testing/trying-assistant/#history)
 - [Memory](https://www.rasa.com/docs/pro/testing/trying-assistant/#memory)
- [Inspecting Voice Assistants](https://www.rasa.com/docs/pro/testing/trying-assistant/#inspecting-voice-assistants)
- [Inspecting Conversations over External Channels](https://www.rasa.com/docs/pro/testing/trying-assistant/#inspecting-conversations-over-external-channels)